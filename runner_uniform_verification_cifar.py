...
if __name__ == '__main__':
    ...
    s1 = []
    s2 = []
    exp_mark = f"CIFAR10_verification_agent{agent_number}_{noise_type}"
    ...
    df.to_csv(f"./CIFAR10/verification_noise_type_{noise_type}_agent{agent_number}.csv", index = False)
