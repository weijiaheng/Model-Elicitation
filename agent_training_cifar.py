...
def train(train_dataloader1, train_dataloader2, test_dataloader, f1, f2, exp_mark):
    ...
    PATH1 = f"./trained_models/cifar10_f1_exp1_{exp_mark}.pth"
    PATH2 = f"./trained_models/cifar10_f2_exp1_{exp_mark}.pth"
...
if __name__ == '__main__':
    ...
    f1 = ResNet34().to(device)     # Choose the model for agent 1
    f2 = Model2().to(device)     # Choose the model for agent 2
    exp_mark = f"CIFAR10_{d_ratio}_{dif_data}_dif_model"
    # Get the dataloader
    train_dataloader1, train_dataloader2, test_dataloader = dataset.cifar10(BATCH_SIZE, d_ratio, IMG_SIZE, dif_data = False)
    # Start training...
