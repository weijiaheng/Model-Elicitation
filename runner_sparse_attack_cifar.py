...
if __name__ == '__main__':
    ...
    for j in range(len(weight_list)):
        ...
        exp_mark = f"CIFAR10_attack_agent{agent_number}_{noise_type}_weight_{weight}"
        ...
        df.to_csv(f"./CIFAR10/attack_noise_type_{noise_type}_agent{agent_number}_weight_{weight}.csv", index = False)
